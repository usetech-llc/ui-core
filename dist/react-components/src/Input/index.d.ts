...
declare function Index({ autoFocus, children, className, defaultValue, help, icon, inputClassName, isAction, isDisabled, isDisabledError, isEditable, isError, isFull, isHidden, isInPlaceEditor, isReadOnly, isWarning, label, labelExtra, loading, max, maxLength, min, name, onBlur, onChange, onEnter, onEscape, onKeyDown, onKeyUp, onPaste, placeholder, tabIndex, type, value, withEllipsis, withLabel }: Props): React.ReactElement<Props>;
